    ...
    <section class="banner py-16 relative">
        ...
        <div class="mx-auto px-4 pt-40 sm:px-12 sm:pt-40 md:pt-32 lg:pt-40 xl:max-w-6xl xl:px-0">
            <div class="flex flex-col items-center max-w-xl mx-auto text-center">
                ...
                <h1 class="block text-center mb-6 text-4xl font-bold text-blue-900 sm:text-5xl lg:text-6xl">Searching Failed...</h1>
                ...
                <div class="mt-8 flex justify-center items-center md:justify-start">
                    <a href="<?= site_url(); ?>" class="relative flex h-12 w-full items-center justify-center px-8 before:absolute before:inset-0 before:rounded-full before:bg-primary-700 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max">
