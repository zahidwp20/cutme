...
<body <?php body_class('bg-white'); ?>>
    ...
    if (is_front_page()) {
                        ...
                        <div class="relative w-full z-20 flex justify-between md:px-0 lg:w-max">
                            <div class="flex items-center">
                                ...
                                <a href="#"
                                    ...
                                    <span
                                        class="inline-block leading-none">https://dribbble.com/jobs/projects/messages?page</span>
                                </a>
                            </div>
        ...
        ?>
        <header>
            <nav class="fixed inset-x-0 z-20 w-full bg-primary-900  lg:py-8 transition-all">
                <div class="mx-auto max-w-7xl px-4 py-4 lg:py-0 lg:px-0 xl:px-0">
                    <div class="relative flex flex-wrap items-center justify-between gap-6 md:gap-0">
                        <div class="relative w-full z-20 flex justify-between md:px-0 lg:w-max">
                            <div class="flex items-center">
                        ...
                        <div id="navlinks"
                            ...
                            <?php wp_nav_menu(
                                array(
                                    'theme_location' => 'primary',
                                    'container_class' => 'text-black lg:w-auto main-menu text-white font-inter font-normal',
                                    'menu_class' => 'cutme-menu-main flex flex-col gap-6 tracking-wide lg:flex-row lg:gap-0 lg:text-xl font-inter font-normal text-white',
                                )
                            ); ?>
                        ...
                        <div
                            class="get-started-area relative pl-4 mt-12 lg:mt-0 lg:flex items-center hidden lg:visible border-gray-100">
                            <div class="vr-line absolute top-1/2 -translate-y-1/2 -left-2 w-[2px] h-4 bg-white"></div>
                            <a href="#" class="relative flex w-full items-center justify-center px-2 sm:w-max">
                                <span>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="relative text-lg text-white ml-4">
                                    Login </span>
                            </a>
                            <a href="#" class="btn-primary-500 py-3 ml-5">
                                <span class="relative z-10">Get Started</span>
