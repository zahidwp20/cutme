...
?>
<section class="mx-auto max-w-7xl py-28 text-gray-700">
                    ...
                    <div class="relative py-5 px-7">
                        <div class="flex items-center gap-4">
                            <img class="h-10 w-10 rounded-full"
                                src="<?php echo get_avatar_url(get_the_author_meta('email')); ?>" alt="user avatar" width="200"
    ...
    <div class="cutme-pagination flex justify-center items-center gap-5 mt-10">
        <?php
        $big = 999999999;
        echo paginate_links(
            array(
